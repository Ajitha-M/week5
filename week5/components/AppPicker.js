...
<TouchableWithoutFeedback onPress={()=>setmodal(true)}>
  ...
  {icon ? <MaterialCommunityIcons style={{marginBottom:25}} name= {icon} color='black' size={35} ></MaterialCommunityIcons> : null }
  
  <AppText >{category}</AppText>
  
  <MaterialCommunityIcons style={{marginLeft:267,marginBottom:30}} name='chevron-down' color='black' size={35} ></MaterialCommunityIcons>
